...
class RedisSessionHandler implements \SessionHandlerInterface
{
    ...
    /** @var string $savePath The redis save path. */
    private $savePath = "";

    /**
     * Construct the redis session handler.
     *
     * @param string $savePath The redis save path.
     *
    ...
    /**
     * Get the current redis save path.
     *
     * @return string The redis save path.
     */
